...
*Wealth score range [min and max not influenced by weights]
...
collapse (mean) wealthscorecont hhwt001 (sum) HHID WQ1 WQ2 WQ3 WQ4 WQ5, by(centroidid)

***Calculation the ultra wealth percentage
gen WQ1prop=(WQ1/HHID)*100
replace WQ1prop=round(WQ1prop, 0.01)

**Calculating the weighted estimates for ultra-poverty at cluster level
tabstat WQ1prop [aw= hhwt001], stats(mean p50 min max) 

**Generating the upper 4 wealth quintiles total
gen PovertyWQ4=WQ2 +WQ3+ WQ4+ WQ5

**Estimating the cluster-level wealth score range
summarize wealthscorecont,detail

**Removing weights in the dataset
drop hhwt001
